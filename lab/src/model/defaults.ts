...
export const TEMPLATES: { id: string; name: string; make: () => Slide }[] = [
  {
    ...
    make: () => createSlide('Editorial title', [
      ...
      T('Motion Culture', 'Instrument Serif', 300, '#b3122e', { x: 80, y: 330, w: 1760 }, { align: 'center', tracking: -0.03 }, { type: 'letters', duration: 1.1, stagger: 0.045, easing: 'expoOut' }),
      createLayer('image', { name: 'Rosette', params: { src: rosetteSvg(), fit: 'contain' }, box: { x: 700, y: 280, w: 520, h: 520 }, anim: { type: 'pop', easing: 'spring', duration: 1.4, delay: 0.6, loop: 'sway', loopSpeed: 0.6, loopAmount: 0.6 }, interact: { parallax: 0.35, hover: 'tilt' } }),
      T('DESIGN SLIDES WITH CONTEXT,\nCOMPOSITION AND STYLE —\nLIKE A CREATIVE DIRECTOR WOULD.', 'Inter', 22, '#b3122e', { x: 110, y: 900, w: 600 }, { weight: '700', lineHeight: 1.25, tracking: 0.02 }, { type: 'words', duration: 0.6, stagger: 0.05, delay: 1.1 }),
      createLayer('ripple', {}),
  ...
  },
  {
    ...
    make: () => createSlide('Statement', [
      createLayer('aurora', {}),
      T('Every slide is a stage.\nEvery build is a beat.', 'Fraunces', 120, '#fff4ec', { x: 200, y: 330, w: 1520 }, { lineHeight: 1.05, weight: '400', italic: false }, { type: 'lines', duration: 1.1, stagger: 0.16, easing: 'expoOut' }),
    ...
    ], '#0b0a1a', { type: 'ripple', duration: 1.4 }),
  },
  {
  ...
  },
  {
    ...
    make: () => createSlide('Big number', [
      ...
      T('74%', 'Unbounded', 380, '#ffe8d6', { x: 160, y: 250, w: 1600 }, { weight: '800', align: 'center', tracking: -0.04 }, { type: 'pop', easing: 'backOut', duration: 1.1, loop: 'pulse', loopAmount: 0.6, loopSpeed: 0.8 }),
      T('of audiences remember the slide that moved.', 'Inter', 44, '#e8c9ff', { x: 360, y: 740, w: 1200 }, { align: 'center', weight: '400' }, { type: 'words', trigger: 'afterPrev', stagger: 0.06, duration: 0.7 }),
    ...
    ], '#0e0b1f', { type: 'zoom', duration: 1 }),
  },
  {
    id: 'image', name: 'Image feature',
    make: () => createSlide('Image feature', [
      createLayer('solid', { params: { color: '#15100f' } }),
      createLayer('image', { name: 'Rosette', params: { src: rosetteSvg(), fit: 'contain' }, box: { x: 110, y: 110, w: 860, h: 860 }, anim: { type: 'blur', duration: 1.4, easing: 'expoOut', loop: 'spin', loopSpeed: 0.08 }, interact: { parallax: 0.5 } }),
      ...
      T('Treat pixels\nlike type.', 'Playfair Display', 124, '#ffe8d6', { x: 1060, y: 330, w: 760 }, { italic: true, lineHeight: 1.0 }, { type: 'words', duration: 0.9, stagger: 0.1, delay: 0.4 }),
      ...
      createLayer('grain', { params: { amount: 0.07 } }),
    ], '#15100f', { type: 'dissolve', duration: 1.3 }),
  },
  {
    ...
    make: () => createSlide('Blueprint', [
      ...
      T('SYSTEM / ARCHITECTURE', 'JetBrains Mono', 24, '#bcd4ff', { x: 140, y: 120, w: 800 }, { weight: '500', tracking: 0.12 }, { type: 'typewriter', stagger: 0.035 }),
      T('How the pieces\nfit together', 'Space Grotesk', 132, '#ffffff', { x: 136, y: 220, w: 1200 }, { weight: '600', lineHeight: 1.0, tracking: -0.03 }, { type: 'lines', stagger: 0.14, duration: 1, delay: 0.3 }),
      createLayer('shape', { name: 'Node A', params: { shape: 'ellipse', fill: '#ffffff', strokeWidth: 0 }, box: { x: 1280, y: 620, w: 120, h: 120 }, anim: { type: 'pop', trigger: 'onClick', easing: 'spring', duration: 1 }, interact: { hover: 'grow' } }),
      createLayer('shape', { name: 'Link', params: { shape: 'arrow', fill: '#8fb8ff' }, box: { x: 1420, y: 655, w: 180, h: 50 }, anim: { type: 'wipeRight', trigger: 'afterPrev', duration: 0.6, easing: 'cubicInOut' } }),
      createLayer('shape', { name: 'Node B', params: { shape: 'rect', radius: 20, fill: '#ff5a36' }, box: { x: 1620, y: 610, w: 140, h: 140 }, anim: { type: 'pop', trigger: 'afterPrev', easing: 'spring', duration: 1 }, interact: { hover: 'grow' } }),
      createLayer('spotlight', { params: { color: '#8fb8ff', radius: 0.4, intensity: 0.35 } }),
    ], '#0d2b5c', { type: 'wipe', duration: 1 }),
  },
  {
    id: 'closing', name: 'Closing',
    make: () => createSlide('Thank you', [
      createLayer('mesh', { params: { color1: '#0f4c5c', color2: '#5fa8d3', color3: '#cae9ff', color4: '#1b263b', speed: 0.9 } }),
      T('Thank you.', 'Instrument Serif', 280, '#ffffff', { x: 160, y: 360, w: 1600 }, { italic: true, align: 'center' }, { type: 'letters', stagger: 0.05, duration: 1.2 }),
