...
section.innerHTML = `<h2>Safe · the full-deck test</h2><p>Build the campaign with reusable slots and existing specialist blocks. Header and footer bands stay fixed; drag the ✥ handles to swap identity / context / logo (and footer closing / page number) between left · centre · right. Changes stay in this mock until you download them.</p>
