...
Sections: `←`/`→` on a section header folds and unfolds it. Folding the
section you are working in hands the selection to its header; selecting a
slide inside a folded section opens it again. Folded, a section drags and
carries as one block, so `⌘X` on its header moves every slide under it.
